...
public class Tokenizer {
    //store all stop words in a set
    private Set<String> stopWords; 
    //instance od Porter stemmer
    private Stemmer stemmer;   

    public Tokenizer(String stopWordsFile) {
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(stopWordsFile))) {
            ...
            System.out.println("File " + stopWordsFile + " Not Found");
			e.printStackTrace();
		}  catch (IOException e) {
			e.printStackTrace();		
		}
...
{  private char[] b;
   ...
   */
   ...
   // {
   //    Tokenizer t = new Tokenizer("StopWords.txt");
   //    String test = "Haiti - Aristide : His return, an international affair... - http://haitilibre.com/fben.php?id=2193";
   //    List<String> res = t.getTokens(test);
   //    for (String s : res) {
   //       System.out.println(s);
   //    } 
